        ...
        >
          {blogPostRecommendationsCard.map(post => (
            <SwiperSlide key={post._id}>
              <article className="bg-pureWhite rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-elegantSilver/20 hover:border-luxuryGold/30 hover:-translate-y-1 h-full flex flex-col">
