        ...
        >
          ...
          >
            {currentImage.photo?.asset?.url && (
              <Image
                src={urlFor(currentImage.photo).width(1200).height(800).quality(95).url()}
                alt={currentImage.photo.alt || `Work example for ${currentImage.name}`}
                width={1200}
                height={800}
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-70 text-white p-6 rounded-b-lg">
              ...
              <p className="text-sm opacity-90 mb-3">{currentImage.role[locale]}</p>
